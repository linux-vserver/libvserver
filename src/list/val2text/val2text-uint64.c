...
static
ssize_t search_value(uint_least64_t val,
                     struct val2text_mapping_uint64 const *map, size_t map_len)
{
	size_t i;
...
ssize_t text2val_uint64(char const *str, size_t len,
