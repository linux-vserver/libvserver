...
#define DECL(VAL) { #VAL, sizeof(#VAL)-1, NXC_ ## VAL }
...
static
uint_least64_t vc_text2ncap_err(const char *str, size_t len, bool *failed)
{
...
int vc_list2ncap(const char *str, size_t len,
                 struct vc_err_listparser *err, struct vc_net_caps *caps)
{
