...
/* socket types */
FLIST32_START(sock_list)
FLIST32_NODE1(VXA_SOCK, UNSPEC)
FLIST32_NODE1(VXA_SOCK, UNIX)
FLIST32_NODE1(VXA_SOCK, INET)
FLIST32_NODE1(VXA_SOCK, INET6)
FLIST32_NODE1(VXA_SOCK, PACKET)
FLIST32_NODE1(VXA_SOCK, OTHER)
FLIST32_END
